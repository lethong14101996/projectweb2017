	...
	<div class="women-product">
		...
		<div class="grid-product">
		  <div class="  product-grid" style="height:285px; width:210px  " >
			<div class="content_box"><a href="single.html">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="database/tablet/galaxytab4.jpeg"  class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				</div>
				    <h4><a href="#"> galaxy tab 2</a></h4>
		  ...
		  <div class="  product-grid" style="height:285px; width:210px  " >
			<div class="content_box"><a href="single.html">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="database/tablet/ipadair.jpg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="#"> ipad air </a></h4>
				     <!--<p>It is a long established fact that a reader</p>-->
				     499
			   	</div>
              </div>
			...
			<div class="content_box"><a href="single.html">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="database/tablet/ipadair2.jpg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="#"> ipad air 2</a></h4>
				     <!--<p>It is a long established fact that a reader</p>-->
				     650
			   	</div>
                 </div>
			...
			<div class="content_box"><a href="single.html">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="database/tablet/ipad2.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="#"> ipad 2</a></h4>
				     <!--<p>It is a long established fact that a reader</p>-->
				      299
			   	</div>
                 </div>
		  <div class="  product-grid" style="height:285px; width:210px  ">
			<div class="content_box"><a href="single.html">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="database/tablet/acer.jpg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="#"> Acer tablet </a></h4>
				     <!--<p>It is a long established fact that a reader</p>-->
				      300
			   	</div>
              </div>
			...
			<div class="content_box"><a href="single.html">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="database/tablet/asusfonepad6.jpg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="#"> asus fonepad 6</a></h4>
				     <!--<p>It is a long established fact that a reader</p>-->
				      200
			   	</div>
                 </div>
			...
			<div class="content_box"><a href="single.html">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="database/tablet/asusnexus7.jpg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="#"> Asus nexus 7</a></h4>
				     <!--<p>It is a long established fact that a reader</p>-->
				    320
			   	</div>
                 </div>
